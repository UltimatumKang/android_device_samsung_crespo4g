...
# name
PRODUCT_RELEASE_NAME := C4G

# device
$(call inherit-product-if-exists, device/samsung/crespo4g/full_4g.mk)
...
PRODUCT_PROPERTY_OVERRIDES += ro.buildzipid=ukg.crespo4g.$(shell date +%m%d%y).$(shell date +%H%M%S)
...
PRODUCT_BUILD_PROP_OVERRIDES += \
    ...
    BUILD_FINGERPRINT="google/soju/crespo4g:4.2.2/JDQ39/573038:user/release-keys"
